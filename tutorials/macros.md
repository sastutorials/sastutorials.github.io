...
**Note:** we've added another built-in function in the conditional logic, **%sysfunc**, which is useful as it allows to **execute SAS functions or user-written functions inside a macro**.
